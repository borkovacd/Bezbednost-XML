...
insert into subject_softwares (id, city, email, has_certificate, software_id, state) values (12, "/", "MTAgent@gmail.com", 1, "SAgent", "/");
insert into subject_softwares (id, city, email, has_certificate, software_id, state) values (13, "/", "localhost@gmail.com", 1, "loclh", "/");

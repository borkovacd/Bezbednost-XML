 ...
 *         &lt;element name="reservationsList" type="{http://ftn.com/webservice}reservationSoap" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetAllReservationsResponse {
    ...
    @XmlElement(required = true)
    protected List<ReservationSoap> reservationsList;
     ...
     * 
     */
    public List<ReservationSoap> getReservationsList() {
        if (reservationsList == null) {
            reservationsList = new ArrayList<ReservationSoap>();
        }

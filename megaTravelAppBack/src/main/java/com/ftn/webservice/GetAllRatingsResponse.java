 ...
 *         &lt;element name="ratingsList" type="{http://ftn.com/webservice}ratingSoap" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetAllRatingsResponse")
public class GetAllRatingsResponse {

    @XmlElement(required = true)
    protected String response;
    @XmlElement(required = true)
    protected List<RatingSoap> ratingsList;
     ...
     * 
     */
    public List<RatingSoap> getRatingsList() {
        if (ratingsList == null) {
            ratingsList = new ArrayList<RatingSoap>();
        }

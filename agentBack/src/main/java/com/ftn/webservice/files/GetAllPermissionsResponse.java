 ...
 *         &lt;element name="permissionslist" type="{http://ftn.com/webservice}permissionSoap" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetAllPermissionsResponse {
    ...
    @XmlElement(required = true)
    protected List<PermissionSoap> permissionslist;
     ...
     * 
     */
    public List<PermissionSoap> getPermissionslist() {
        if (permissionslist == null) {
            permissionslist = new ArrayList<PermissionSoap>();
        }
